...
config['stu_weight_path'] = 'weight/imagenet12-vgg16/subspace_cluster/single5x/stage3/stage2_epoch12_iter2811.pth'
...
config['topC'] = 0
config['randomN'] = 200
config['exp_name'] = 'single5x/stage3'
config['explain'] = 'vgg165x stage3; using final featuremaps at the stage3'
config['start_epoch'] = 13
