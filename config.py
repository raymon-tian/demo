...
config['stu_weight_path'] = 'weight/imagenet12-vgg16/subspace_cluster/conv1_1/stage2_epoch4.pth'
...
config['topC'] = 3
config['randomN'] = 10
config['exp_name'] = 'conv2_1'
config['explain'] = 'compress the conv2_1 layer'
config['topK'] = 1