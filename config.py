...
config['stu_weight_path'] = 'weight/imagenet12-vgg16/subspace_cluster/single4x/stage3/stage3_epoch14.pth'
...
config['explain'] = 'single4x fine-tune'
config['start_epoch'] = 15